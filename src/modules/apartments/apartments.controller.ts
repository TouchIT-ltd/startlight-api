...
export class ApartmentsController {
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        description: { type: 'string', example: 'A lovely apartment with natural light' },
        price: { type: 'number', example: 1200 },
        priceUnit: { type: 'string', enum: ['mo', 'year'] },
        ...
        minTermUnit: { type: 'string', enum: ['month', 'year'] },
        amenities: { type: 'array', items: { type: 'string' }, example: ['WiFi', 'Parking'] },
        images: { type: 'string', format: 'binary', description: 'Upload up to 5 images' },
      },
  ...
  @ApiOkResponse({ description: 'List of apartments', type: PaginatedApartmentsDto })
  ...
  @ApiResponse({ status: 200, description: 'Apartment found', type: ApartmentResponseDto })
